          ...
          >
            <div >
              ...
              <div class="divide-y divide-slate-200">
                <div class="flex p-2 gap-2">
                  ...
                  <div class="flex flex-col w-10/12">
                    <p class="text-sm">
                      Congratulations! You've been promoted to Expensify
                      Newcomer.
                    </p>
                ...
                <div class="flex p-2 gap-2">
                  ...
                  <div class="flex flex-col w-10/12">
                    <p class="text-sm">
                      ...
                      <strong
                        >How can I connect expensify to my own custom
                        dashboard?</strong
                      >
                    </p>
                    <time class="text-xs text-gray-500">May 7, 2022</time>
              ...
              <div class="flex items-center justify-between p-3 border-t-2">
                ...
                <button class="font-semibold text-blue-500 text-sm">
                  Mark All Read
                </button>
              </div>
            </div>
        ...
        <div class="relative" v-click-out-side="closeMessage">
          ...
          >
            <div>
              ...
              <div class="divide-y divide-slate-200">
                <p class="mx-4 my-8 text-sm text-gray-700">
